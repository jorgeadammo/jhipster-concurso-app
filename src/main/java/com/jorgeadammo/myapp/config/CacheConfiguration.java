package com.jorgeadammo.myapp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("concursoApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("concursoApp");
        ...
        config.getMapConfigs().put("com.jorgeadammo.myapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
